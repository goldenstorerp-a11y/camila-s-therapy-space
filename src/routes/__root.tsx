...
function RootShell({ children }: { children: ReactNode }) {
  return <html lang="pt-BR"><head><HeadContent /><style>{`.photo-card img.camila-photo{content:url('/camila-nunes.jpg');object-fit:cover;object-position:center top}`}</style></head><body>{children}<Scripts /></body></html>;
}

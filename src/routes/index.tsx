...
const CAMILA_PHOTO = "/camila-nunes.jpg";
        ...
        <section className="hero" id="inicio">
          <div className="container hero-grid">
            <div className="hero-content">
              ...
              <div className="hero-buttons"><a className="primary-button" href={WHATSAPP} target="_blank" rel="noreferrer">Conversar com a Camila</a><a className="secondary-link" href="#sobre">Conheça meu trabalho <span>→</span></a></div>
              <div className="hero-note"><span>Atendimento psicológico individual</span><span>Online</span></div>
            </div>
            <div className="hero-photo-area">
              <div className="photo-card"><img src={CAMILA_PHOTO} alt="Camila Nunes, psicóloga" className="camila-photo" loading="eager" decoding="async"/><div className="photo-label"><strong>Camila Nunes</strong><span>Psicóloga</span></div></div>
